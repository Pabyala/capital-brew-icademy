            ...
            <div className='container lg:px-8'>
                <div className='flex justify-between items-center h-[50px] lg:container'>
                    ...
                    <div className='flex justify-between items-center w-full'>
                        <div onClick={() => dispatch(setModalShow('showSideMenu'))} className='flex justify-center items-center'>
                            <BurgerMenu size={25}/>
                        </div>
                        ...
                        <div onClick={() => dispatch(setModalShow('showSideCard'))} className='relative flex justify-center items-center cursor-pointer'>
                            <Cart size={25}/>
