    ...
    return (
        <div className='fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4'>
            <div className="w-full max-w-4xl bg-white rounded overflow-hidden shadow max-h-[90vh] my-auto flex flex-col">
                <div className='relative bg-white p-5 space-y-3 rounded-xl shadow-sm flex flex-col max-h-[90vh] justify-between '>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {temperature.map((temp) => {
                                        ...
                                        return (
                                            <label
                                                key={temp.id}
                                                className={`flex items-center gap-2 px-1.5 py-0.5 rounded border cursor-pointer transition
